...
import com.example.debtfree.databinding.ActivityAddnewDeptdataBinding;
...
//            }
        ...
        instarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String link = "https://www.instagram.com/g.k.lawaniya1/";
        ...
        youtubearrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(addnew_deptdata.this,webview_Activity.class);
                String link = "https://www.youtube.com/@guddulawaniya4554/featured";
                intent.putExtra("link",link);
                startActivity(intent);
            }
        });
